...
var (
	...
	MantleHoleskyQA2UpgradeConfig = MantleUpgradeChainConfig{
		...
		BVMETHMintUpgradeTime: u64Ptr(0),
		MetaTxV2UpgradeTime:   u64Ptr(0),
		MetaTxV3UpgradeTime:   u64Ptr(1_740_033_000),
		ProxyOwnerUpgradeTime: u64Ptr(1_740_033_000),
		MantleEverestTime:     u64Ptr(1_740_033_000),
	}
...
func GetUpgradeConfigForMantle(chainID *big.Int) *MantleUpgradeChainConfig {
	...
	case params.MantleHoleskyQA2ChainId.Int64():
		return &MantleHoleskyQA2UpgradeConfig
